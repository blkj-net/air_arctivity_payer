...
return [
    ...
    'official_account' => [
        'default' => [
            // AppID
            'appId' => env('WECHAT_OFFICIAL_ACCOUNT_APPID', 'your-app-id'),
            // AppSecret
            'appSecret' => env('WECHAT_OFFICIAL_ACCOUNT_SECRET', 'your-app-secret'),
            // Token
    ...
    'payment'          => [
        'default' => [
            ...
            'refund_notify_url' => env('WECHAT_REFUND_NOTIFY_URL', 'http://fuwu.wyz.ltd/payments/refund_notify') // 退款回调的通知
        ],
        // ...
    ],
    //企业微信
